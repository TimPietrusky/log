...
- [Spending time in Hamburg: Improving health + music skills](#spending-time-in-hamburg-improving-health--music-skills)
...
* FaPi has a new partner already (as we lived in an open relationship for 5 years) which was hard for me to adapt to for two reasons
  1. Experiencing FaPi with her new partner in the day to day life (this was resolved very quickly, the hardest part was to overcome the nicknames I had for FaPi which are exclusive for a romantic relationship)
  2. I saw my role as a father in danger (this is resolved now as I'm writing)
...
[![RainbowGridWave / Video 1](videos/20210214_RainbowGridWave_video_1.webp)](videos/20210214_RainbowGridWave_video_1.mp4)
...
[![RainbowGridWave / Video 2](videos/20210214_RainbowGridWave_video_2.webp)](videos/20210214_RainbowGridWave_video_2.mp4)
...
[![RainbowGridWave / Video 3](videos/20210214_RainbowGridWave_video_3.webp)](videos/20210214_RainbowGridWave_video_3.mp4)
...
[![RainbowGridWave / Video 4](videos/20210214_RainbowGridWave_video_4.webp)](videos/20210214_RainbowGridWave_video_4.mp4)
...
[![RainbowGridWave / Video 5](videos/20210214_RainbowGridWave_video_5.webp)](videos/20210214_RainbowGridWave_video_5.mp4)
...
* [luminave](https://github.com/NERDDISCO/luminave) was used to have a visual representation of the Novation LaunchPad mk2 that I'm using to compose the different visual modules from modV with each other
...
* What are the basics of creating a shader in GLSL (WebGL Shader Language) and how to run it in the browser?
  * I learned the basic from "Char Stiles" [Shaders](https://codame.com/events/shaders) workshop at CODAME
  * [The Book of Shaders](https://thebookofshaders.com/)
  * [Starting with Shaders](https://www.ilithya.rocks/blog/starting-with-shaders/#heading-how-i-got-started-with-shaders)
  * [https://www.youtube.com/watch?v=ch4BYqkL1w8&list=PL0kTSdIvQNCNE-BDKOlYu628AalMmXy_P&index=3](https://www.youtube.com/watch?v=ch4BYqkL1w8&list=PL0kTSdIvQNCNE-BDKOlYu628AalMmXy_P&index=3)
...
* Get inspiration
  * [Lea Rosema](https://github.com/terabaud/hello-webgl)
  * [curiouslyminded](https://www.curiouslyminded.xyz/)
  * [Sol Sarratea](https://visualizer.solquemal.com/)
  * [Char Stiles](http://charstiles.com/)
  * [PixelSpiritDeck](https://patriciogonzalezvivo.github.io/PixelSpiritDeck/)
  * [Shadertoy](https://shadertoy.com)
  * [ISF Editor](https://editor.isf.video/shaders?q=&category=&sort=Date+Created+%E2%86%93&page=0)
  * [GLSL Sandbox](http://glslsandbox.com/)
  * [Observable](https://observablehq.com/@makio135/hello-fragment?collection=@makio135/webgl)
  * [smoothstep.io](https://smoothstep.io/)
  * Open Source ISF resources
    * [https://github.com/Vidvox/ISF-Files/tree/master/ISF](https://github.com/Vidvox/ISF-Files/tree/master/ISF)
    * [https://github.com/icalvin102/ISF](https://github.com/icalvin102/ISF)
    * [https://github.com/n1ckfg/ISF-Folder](https://github.com/n1ckfg/ISF-Folder)
    * [https://github.com/grigM/ISF-shaders-collection](https://github.com/grigM/ISF-shaders-collection)
...
When doing shows as [LiveJS](https://livejs.network/) we always do lights, visuals and music. One of our musicians is [DESTROY WITH SCIENCE](https://destroywithscience.bandcamp.com/) and he is using a lot of different synths in combination with [rust-loop-drop](https://github.com/mmckegg/rust-loop-drop) (a software to control the synths without a GUI). Using synths and some custom software sounded like a good idea to me, so I started to buy some synths in 2020. By the start of this year I finally managed to actually use them in combination with loop drop together with GrAd. And it was a big pain to get anything working :D

It literally took us 2 days to get a basic setup running where everything was in sync with the MIDI clock (provided by [RK-006](https://www.retrokits.com/shop/rk006/)), but in the end we were able to create some music. 
...
* Get every synth in tune using an app on my mobile device (I'm using `Pitch` for iOS)
* Find a base pattern for the drums, build on top of that
...
[![NERDDISCO / Getting Started with Loop Drop - 1](videos/20210305_NERDDISCO_GettingStartedWithLoopDrop_1.webp)](videos/20210305_NERDDISCO_GettingStartedWithLoopDrop_1.mp4)

[![NERDDISCO / Getting Started with Loop Drop - 2](videos/20210305_NERDDISCO_GettingStartedWithLoopDrop_2.webp)](videos/20210305_NERDDISCO_GettingStartedWithLoopDrop_2.mp4)

[![NERDDISCO / Getting Started with Loop Drop - 3](videos/20210305_NERDDISCO_GettingStartedWithLoopDrop_3.webp)](videos/20210305_NERDDISCO_GettingStartedWithLoopDrop_3.mp4)
